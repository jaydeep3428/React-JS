            ...
            <div className="container-fluid">
                <section className="text-secondary">
                    <div className="map container py-5 d-flex">
                        <div className="col-lg-6 col-md-6 bg-light rounded overflow-hidden me-md-3 p-4 d-flex align-items-end justify-content-start ">
                            <iframe
                                width="100%"
                                height="100%"
                                className=""
                        ...
                        <div className="col-lg-6 col-md-6 bg-white d-flex flex-column ms-md-auto py-4 mt-4 mt-md-0">
                            <h2 className="text-dark h5 mb-1 font-weight-medium">Feedback</h2>
                            <p className="text-muted mb-4">Post-ironic portland shabby chic echo park, banjo fashion axe</p>
                            <div className="mb-3">
                            ...
                            <button className="btn mt-4 btn-primary text-white">Submit</button>
                            <p className="text-muted mt-3 small">Chicharrones blog helvetica normcore iceland tousled brook viral artisan.</p>
                        </div>
                    </div>
                </section>
            </div>
